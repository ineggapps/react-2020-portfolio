    ...
    <>
      <Content bgColor="#FAFAFA">
        <Intro>
          ...
          <p className="intro">
            저는 문제에 대해 생각하고 해결하는 과정을 즐기는 편입니다. 그래서 개발하는 것을
            좋아했습니다. 그리고 흥미를 느끼면 어떻게든 목표를 이루고자 쟁취하는 성격입니다. HTML로
            홈페이지를 만드는 것에 흥미를 느끼며 초등학생 때 메모장으로 태그를 연습했던 작은 공부가
            지금은 취미를 넘어 일상이 되었습니다.
          </p>
          <p className="button">
      ...
      <Content>
        <SkillOverview>
          <h2>무엇을 해왔나요?</h2>
          <p>
            어렸을 때부터 컴퓨터를 공부했지만, 특히 웹에 관심이 많았습니다. 특성화 고등학교에
            진학했을 때부터 웹 표준 동아리에 가입하여 웹 트렌드에 관해 공부를 시작했습니다. 빠른
            기술 발전 속도에 따라 수시로 바뀌는 트렌드에 적응하고자 노력해 온 것처럼, 자기
