...
export const skillsOfProgramming = [
  {
    ...
    img: "/java.png",
    content:
      "객체지향 패러다임을 이해하고 각 역할별로 클래스를 분리할 수 있습니다. 저의 자바 선생님은 안드로이드가 8할이라고 할 수 있는 만큼 교육과정을 수강하면서 많은 문법과 디자인 패턴들을 익혔습니다. 또한, Oracle 데이터베이스에 있는 내용을 인출하여 알맞게 입출력할 수 있습니다. ",
  },
];
